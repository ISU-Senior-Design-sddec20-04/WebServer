            ...
            <div>
                <div className={'CurrentlyPlayingContainer'}>
                    ...
                    <div className={'ImageContainer'}>
                        <img src={this.state.image} alt={'Track Preview'} className={'TrackImage'}/>
                    </div>
                </div>
