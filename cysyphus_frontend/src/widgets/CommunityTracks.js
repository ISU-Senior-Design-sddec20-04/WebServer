...
export class CommunityTracks extends React.Component {
    ...
    componentDidMount() {
        ...
        this.favoritesList = Repository.getUserFavorites(this.user.id)
    }
    ...
    searchTracksFor(trackList, searchCriteria, favoritesOnly){
        return trackList.filter(track =>
            ...
            ((!favoritesOnly) || ((favoritesOnly) && this.favoritesList.has(track.id)))
        );
    }
        ...
        return(
            <div className={'CommunityTracksContainer'}>
                <div className={'CTSearchContainer'}>
                   ...
                   <button onClick={this.toggleSortFav}>
                ...
                <ul className={'CTList'}>
                    <CommunityTrackList trackList={this.state.searchedTracks} user={this.user} favs={this.favoritesList}/>
                </ul>
            </div>
        )
    }
...
function CommunityTrackList(props){
    ...
    return props.trackList.map((track) =>
        <CommunityTrackItem key={track.id} track={track} preview={preview} user={props.user}
                            favorited={props.favs.has(track.id)}/>
    );
}